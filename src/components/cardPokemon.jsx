...
export default function PokemonCard(props) {
  ...
  return (
    ...
    hover:bg-opacity-30 rounded-xl flex justify-center align-middle items-center "
    >
      ...
      >
        <div className="  font-semibold text-white  md:font-extralight text-neutral-50/50 hover:font-bold flex flex-col bg-black/50 items-center p-0.5 ">
          ...
          <div className=" pb-2 flex justify-center items-center align-middle text-center flex-row sm:hover:translate-x-2 hover:translate-y-2   ">
            <MandoMorado />
            <div className=" flex ">
